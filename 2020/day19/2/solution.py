...
def get_regexp(rules,rule_num):
    ...
    if rule_num==8:
        r= get_regexp(rules,42)
        return f'({r}|({r}|({r}|({r}|({r}|({r}))))))+'
    if rule_num==11:
        r42 = get_regexp(rules,42)
        r31 = get_regexp(rules,31)
        return f'(({r42}{r31})|{r42}(({r42}{r31})|{r42}((({r42}{r31})|{r42}((({r42}{r31})|{r42}((({r42}{r31})|{r42}{r31})){r31})){r31})){r31}){r31})'
    res = []
